...
For full doccumentations of all functions in the package please read the [vignette](https://source.cloud.google.com/dcms-datalake-staging/Rbduk/+/master:vignettes/Vignette.md).
