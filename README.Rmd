...
For full doccumentations of all functions in the package please read the [vignette](https://github.com/SamA-DS/Rbduk/blob/main/vignettes/Vignette.md) or run `vignette("Vignette",package="Rbduk")` to view it within R.
